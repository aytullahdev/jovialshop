...
const Card = (props) => {
    ...
    return (
        <div className=' shadow rounded-md p-5 cursor-pointer'>
            ...
            <div>
                <button onClick={()=>{ orderItem()}} className='px-20 py-2 block mx-auto hover:bg-green-600 bg-green-500 text-xl text-white uppercase rounded'>Order Now</button>
            </div>
        </div>
    );
};
